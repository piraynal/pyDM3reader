...
public class DM3_Reader extends ImagePlus implements PlugIn 
{
	...
	private static final int debugLevel = 0; //  0=none, 1-3=basic, 4-5=simple, 6-10 verbose
	...
	public ImagePlus load(String directory, String fileName) /*throws IOException*/ {
		...
		for (int i = 0; i<storedTags.size();i++){
			...
			notes+=(String) storedTags.elementAt(i) + "\n";
		}
	...
	// handling specific data types
		...
		if(etSize>0){
			// must be a regaular data type, so read it and store a tag for ir
		...
		{
			// This does not store tags at present
